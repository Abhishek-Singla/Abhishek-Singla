...
export const defaultPortfolioData: PortfolioData = {
  ...
  bioSummary: "Senior Product Leader specializing in high-scale core payments, settlement orchestration, and Unified NPCI integration layers (UPI, BBPS). Dedicated to breaking down complex financial plumbing into resilient, high-converting checkout engines.",
  aboutMarkdown: "I am a Product Manager specializing in the engineering architecture and security frameworks that power high-velocity financial transactions.\n\nOver the past 6+ years, I have scaled payment routing networks, led dual-entry reconciliation ledgers, and designed API integration layers for thousands of enterprise merchants. I have a deep passion for breaking down complex, multi-hop financial engines into clear, optimized models. This passion is highlighted in my **Bharat Bill Payment System (BBPS) article and deconstructive teardown**, where I transform unstructured, high-latency API loops into a predictable PM playbook that recovers lost checkout conversions.\n\nMy philosophy is that top-tier fintech systems are not defined by visual gimmicks. They are won on 99.99% settlement precision, microsecond latencies, and robust transaction recovery. I enjoy bridging compliance, technical architecture, and merchant experience to build enduring payment products.",
  socials: {
